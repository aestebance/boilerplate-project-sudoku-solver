    ...
    suite('POST request to /api/solve', function() {
       ...
       test('Solve a puzzle with invalid characters', function(done) {
           chai.request(server)
               .post('/api/solve')
               .send({
                   puzzle: "1.5..2.84..63.12.7.2..5.....9..1..c.8.2.3674.3.7.2..9.47...8..1..16....926914.37."
               })
               .end(function(error, res){
                   assert.equal(res.status, 200);
       ...
       test('Solve a puzzle that cannot be solved', function(done){
           chai.request(server)
               .post('/api/solve')
               .send({
                   puzzle: "55.91372.33..8.5.9.9.25..8.68.47.23...95..46.7.4.....5.2.......4..8916..85.72...3"
               })
               .end(function(err, res){
                   assert.equal(res.status, 200);
    ...
    suite('POST request to /api/check', function() {
        ...
        test('Check a puzzle placement with invalid characters', function(done){
            chai.request(server)
                .post('/api/check')
                .send({
                    puzzle: "..9..5.1.85.4....2432...c..1...69.83.9.....6.62.71...9......1945....4.37.4.3..6..",
                    coordinate: "A2",
                    value: "9"
                })
                .end(function(err, res){
